...
SNCUTS_CONF=/sps/nemo/scratch/ayanko/kink_track_study_Anna/214Bi/

$FALAISE_BIN/flreconstruct -i $WORKDIR/reco.brio -p /sps/nemo/scratch/ayanko/kink_track_study_Anna/214Bi/SNCutsPipelineTEST.conf -o $WORKDIR/reco_cuts.brio
