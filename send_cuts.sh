...
$FALAISE_BIN/flreconstruct -i $WORKDIR/reco.brio -p /sps/nemo/scratch/ayanko/kink_track_study_Anna/0nu/SNCutsPipelineKK.conf -o $WORKDIR/reco_cutsKK.brio
$FALAISE_BIN/flreconstruct -i $WORKDIR/reco.brio -p /sps/nemo/scratch/ayanko/kink_track_study_Anna/0nu/SNCutsPipelineSS.conf -o $WORKDIR/reco_cutsSS.brio
$FALAISE_BIN/flreconstruct -i $WORKDIR/reco.brio -p /sps/nemo/scratch/ayanko/kink_track_study_Anna/0nu/SNCutsPipelineKS.conf -o $WORKDIR/reco_cutsSK.brio
